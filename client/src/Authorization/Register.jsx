...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await AxiosInstance.post("lender/signup", data, {
        headers: {
      ...
      <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        ...
        <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20 border border-gray-300">
          <div className="max-w-md mx-auto">
            <h1 className="text-3xl font-semibold text-center text-gray-800">Lender Registration</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mt-6">
              ...
              <div className="text-sm text-gray-600 text-center">
                ...
                <Link to="/lenderLogin" className="text-blue-500 hover:underline">
                  Login here
                </Link>
              </div>
            </form>
